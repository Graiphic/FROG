...
<hr/>
<h2>Overview</h2><p>The Table family defines standardized widgets for flat row-and-column tabular data. It provides a bounded class law and keeps virtualization, host-native rendering, and advanced editing downstream from the public widget contract.</p>
