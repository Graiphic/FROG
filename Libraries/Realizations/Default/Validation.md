...
<ul>
  ...
  <li>Visible skin ownership should be singular. When a Default SVG part, subobject resource, or realization composition owns a border, fill, popup panel, row face, selection face, or equivalent surface, host renderers should not add an independent duplicate border or fill for that same visual surface.</li>
