...
fn render_enum_widget(widget: &Value, asset_path: Option<&PathBuf>) -> String {
    ...
    format!(
        ...
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.fill_color", "#ffffff"), "#ffffff")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.border_color", "#64748b"), "#64748b")),
        escape_html(&safe_css_length(&runtime_string(runtime, "style.popup.border_width", "1px"), "1px")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.option.fill_color", "#ffffff"), "#ffffff")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.option.text_color", "#111827"), "#111827")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.option.hover_fill_color", "#2563eb"), "#2563eb")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.option.hover_text_color", "#ffffff"), "#ffffff")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.option.selected_fill_color", "#2563eb"), "#2563eb")),
        escape_html(&safe_css_color(&runtime_string(runtime, "style.popup.option.selected_text_color", "#ffffff"), "#ffffff")),
        escape_html(&safe_css_font_family(&runtime_string(runtime, "style.popup.option.font_family", "Segoe UI,Arial,sans-serif"), "Segoe UI,Arial,sans-serif")),
        escape_html(&safe_css_length(&runtime_string(runtime, "style.popup.option.font_size", &text_size), &text_size)),
        escape_html(&safe_css_font_weight(&runtime_string(runtime, "style.popup.option.font_weight", "400"), "400")),
        escape_html(&safe_css_font_style(&runtime_string(runtime, "style.popup.option.font_style", "normal"), "normal")),
        escape_html(&safe_css_length(&runtime_string(runtime, "style.popup.option.padding_inline", &text_padding), &text_padding)),
        escape_html(&safe_css_length(&runtime_string(runtime, "style.popup.option.height", "28px"), "28px")),
