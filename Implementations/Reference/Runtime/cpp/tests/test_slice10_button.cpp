...
void test_button_runtime_core_consumes_frog_instance_and_wfrog_assets() {
    ...
    assert(runtime.widgets.at("pressed_indicator").properties.at("style.state_face.border_width").as_string() == "0px");
    ...
    assert_contains(default_button_wfrog, "frog.realizations.default.button.button_face.bounds");
    ...
    assert_contains(default_button_wfrog, "\"style.button_face.*\"");
...
void test_button_browser_ui_surface() {
    ...
    assert_contains(html, "<dt>Reviewed</dt><dd>2026-06-16</dd>");
    ...
    assert_contains(html, "--boolean-state-face-border-width:0px;");
    assert_contains(html, "class='boolean-state-overlay' data-frog-part='state_text' data-svg-anchor='state_text.center' style='");
    assert_contains(html, "indicator.querySelector(\".boolean-state-overlay[data-frog-part='state_text']\")");
    assert_contains(html, "font-size:var(--boolean-caption-font-size)");
    assert_contains(html, "border:var(--boolean-state-face-border-width) solid var(--boolean-state-face-border)");
