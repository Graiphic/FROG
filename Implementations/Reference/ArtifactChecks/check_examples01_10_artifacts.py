#!/usr/bin/env python3
"""Check that the published Examples 01-10 executable corridor artifacts exist.
...
EXAMPLE_ARTIFACTS: dict[str, list[str]] = {
    ...
    "06_boolean_value_roundtrip": [
        "Examples/06_boolean_value_roundtrip/main.frog",
        "Examples/06_boolean_value_roundtrip/main.fir.json",
        "Examples/06_boolean_value_roundtrip/main.lowering.json",
        "Examples/06_boolean_value_roundtrip/ui/boolean_panel.wfrog",
        ...
        "Implementations/Reference/Runtime/acceptance/example06_input_false.snapshot.json",
        "Implementations/Reference/Runtime/acceptance/example06_input_true.snapshot.json",
        "Implementations/Reference/LLVM/examples/06_boolean_value_roundtrip/module.ll",
        "Implementations/Reference/LLVM/examples/06_boolean_value_roundtrip/build.sh",
        "Implementations/Reference/LLVM/examples/06_boolean_value_roundtrip/expected-output.json",
    ...
    "07_string_value_roundtrip": [
        "Examples/07_string_value_roundtrip/main.frog",
        "Examples/07_string_value_roundtrip/main.fir.json",
        "Examples/07_string_value_roundtrip/main.lowering.json",
        "Examples/07_string_value_roundtrip/ui/string_panel.wfrog",
        ...
        "Implementations/Reference/LLVM/examples/07_string_value_roundtrip/module.ll",
        "Implementations/Reference/LLVM/examples/07_string_value_roundtrip/build.sh",
        "Implementations/Reference/LLVM/examples/07_string_value_roundtrip/expected-output.json",
    ...
    "08_enum_value_roundtrip": [
        "Examples/08_enum_value_roundtrip/main.frog",
        "Examples/08_enum_value_roundtrip/main.fir.json",
        "Examples/08_enum_value_roundtrip/main.lowering.json",
        "Examples/08_enum_value_roundtrip/ui/enum_panel.wfrog",
        ...
        "Implementations/Reference/LLVM/examples/08_enum_value_roundtrip/module.ll",
        "Implementations/Reference/LLVM/examples/08_enum_value_roundtrip/expected-output.json",
    ...
    "09_path_value_roundtrip": [
        ...
        "Examples/09_path_value_roundtrip/main.fir.json",
        "Examples/09_path_value_roundtrip/main.lowering.json",
        ...
        "Implementations/Reference/LLVM/examples/09_path_value_roundtrip/module.ll",
        "Implementations/Reference/LLVM/examples/09_path_value_roundtrip/build.sh",
        "Implementations/Reference/LLVM/examples/09_path_value_roundtrip/expected-output.json",
    ...
    "10_button_press_to_boolean": [
        ...
        "Examples/10_button_press_to_boolean/main.fir.json",
        "Examples/10_button_press_to_boolean/main.lowering.json",
        ...
        "Implementations/Reference/Runtime/acceptance/example10_button_press_to_boolean.acceptance.json",
        "Implementations/Reference/LLVM/examples/10_button_press_to_boolean/module.ll",
...
REQUIRED_TOOLS = [
    ...
    "Implementations/Reference/Runtime/check_examples01_10_runtime_acceptance.py",
    "Implementations/Reference/LLVM/tools/emit_lowering_to_llvm.py",
    "Implementations/Reference/Pipeline/check_examples01_10_full.py",
]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Check published Examples 01-10 reference artifacts.")
