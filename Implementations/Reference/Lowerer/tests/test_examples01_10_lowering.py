...
CASES = [
    ...
    ("06_boolean_value_roundtrip", "Examples/06_boolean_value_roundtrip/main.fir.json", "Examples/06_boolean_value_roundtrip/main.lowering.json"),
    ("07_string_value_roundtrip", "Examples/07_string_value_roundtrip/main.fir.json", "Examples/07_string_value_roundtrip/main.lowering.json"),
