...
def emit_button_switch_when_released_to_boolean(lowering: dict[str, Any]) -> str:
    ...
    expect_equal(kernel.get("operation"), "copy", "button_switch_when_released expects copy operation")
    expect_equal(kernel.get("src"), "trigger_value", "button_switch_when_released expects src trigger_value")
    expect_equal(kernel.get("dst"), "switched", "button_switch_when_released expects dst switched")
    expect_equal(kernel.get("type"), "bool", "button_switch_when_released expects bool copy type")
