...
LOWERING = ROOT / "Examples" / "08_enum_value_roundtrip" / "main.lowering.json"
EXPECTED = ROOT / "Implementations" / "Reference" / "LLVM" / "examples" / "08_enum_value_roundtrip" / "module.ll"


def test_example08_llvm_emission_check_passes() -> None:
...
def test_example08_llvm_emitter_writes_module(tmp_path: Path) -> None:
    ...
    assert "define void @frog_example08_run" in generated
    assert "%FrogEnumRunResult = type { i8, i16, i16 }" in generated
