; Example 21 Ring Selection Roundtrip native proof kernel.
; The selected Ring numeric item value is copied to the public output so the
; example remains on the manifest-backed native artifact corridor.

%FrogRunResult = type { i8, i16, i16 }

define dso_local void @frog_example21_run(i16 %mode_value, ptr %out_result) {
entry:
