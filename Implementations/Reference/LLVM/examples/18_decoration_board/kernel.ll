; Example 18 Decoration Board native proof kernel.
; The front panel Decoration widgets are support visuals; this kernel only
; publishes a manifest-backed scene_ready bool so the example remains on the
; native artifact corridor without assigning scalar value semantics to
; decorations.

%FrogBoolRunResult = type { i8, i8, i16 }

define dso_local void @frog_example18_run(i8 %scene_ready_request, ptr %out_result) {
entry:
