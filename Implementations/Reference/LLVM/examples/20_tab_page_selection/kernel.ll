; Example 20 Tab Page Selection native proof kernel.
; The selected Tab page id is copied to the public output so the example
; remains on the manifest-backed native artifact corridor.

%FrogStringRunResult = type { i8, i16, i32, [256 x i8] }

define dso_local void @frog_example20_run(ptr %input_ptr, i32 %input_len, ptr %out_result) {
entry:
