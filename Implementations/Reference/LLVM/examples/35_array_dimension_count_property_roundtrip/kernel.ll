; Example 35 FROG native kernel artifact: Array index-display dimension-count property roundtrip.
...
source_filename = "Examples/35_array_dimension_count_property_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogRunResult = type { i8, i16, i16 }

define void @frog_example35_run(i16 %element_value, ptr %out_result) {
entry:
