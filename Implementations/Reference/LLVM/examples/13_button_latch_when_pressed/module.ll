; FROG example 13 - LLVM Button latch_when_pressed Boolean proof
; Emitted from the published Example 13 lowered Button value copy kernel.
;
...
define i1 @frog_example13_copy_button_value(i1 %trigger_value) {
entry:
...
run:
  ...
  %latched = call i1 @frog_example13_copy_button_value(i1 %trigger_value)
