; FROG example 15 - LLVM Button latch_until_released Boolean proof
; Emitted from the published Example 15 lowered Button value copy kernel.
;
...
define i1 @frog_example15_copy_button_value(i1 %trigger_value) {
entry:
...
run:
  ...
  %latched = call i1 @frog_example15_copy_button_value(i1 %trigger_value)
