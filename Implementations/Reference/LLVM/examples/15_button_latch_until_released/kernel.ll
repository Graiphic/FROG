; FROG Example 15 - native Button latch_until_released Boolean kernel ABI proof artifact
...
;
;   void frog_example15_run(uint8_t trigger_value, FrogBoolRunResult* out_result)
;
