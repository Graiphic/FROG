source_filename = "Examples/37_array_path_container_dimension_count_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogStringRunResult = type { i8, i16, i32, [256 x i8] }

define void @frog_example37_run(ptr %input_ptr, i32 %input_len, ptr %out_result) {
entry:
