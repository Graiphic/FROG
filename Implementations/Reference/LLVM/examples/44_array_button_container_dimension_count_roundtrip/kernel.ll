source_filename = "Examples/44_array_button_container_dimension_count_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogBoolRunResult = type { i8, i8, i16 }

define void @frog_example44_run(i8 %input_value, ptr %out_result) {
entry:
