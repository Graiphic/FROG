; Example 23 Table Cell Selection Roundtrip native proof kernel.
; The selected Table numeric cell value is copied to the public output so the
; example remains on the manifest-backed native artifact corridor.

%FrogRunResult = type { i8, i16, i16 }

define dso_local void @frog_example23_run(i16 %cell_value, ptr %out_result) {
entry:
  ...
  store i16 %cell_value, ptr %result_ptr, align 2
