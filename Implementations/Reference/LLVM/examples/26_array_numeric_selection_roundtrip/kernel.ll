; Example 26 Array Numeric Selection Roundtrip native proof kernel.
; The selected Array numeric element value is copied to the public output so the
; example remains on the manifest-backed native artifact corridor.

%FrogRunResult = type { i8, i16, i16 }

define dso_local void @frog_example26_run(i16 %element_value, ptr %out_result) {
entry:
