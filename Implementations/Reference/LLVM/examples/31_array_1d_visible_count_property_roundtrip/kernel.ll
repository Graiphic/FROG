; Example 31 FROG native kernel artifact: 1D Array visible-count property roundtrip.
...
source_filename = "Examples/31_array_1d_visible_count_property_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogRunResult = type { i8, i16, i16 }

define void @frog_example31_run(i16 %element_value, ptr %out_result) {
entry:
