; Example 33 FROG native kernel artifact: 2D Array container with Numeric element roundtrip.
...
source_filename = "Examples/33_array_2d_numeric_container_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogRunResult = type { i8, i16, i16 }

define void @frog_example33_run(i16 %element_value, ptr %out_result) {
entry:
