; Example 30 FROG native kernel artifact: 1D horizontal Array container with Numeric element roundtrip.
...
source_filename = "Examples/30_array_1d_horizontal_numeric_container_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogRunResult = type { i8, i16, i16 }

define void @frog_example30_run(i16 %element_value, ptr %out_result) {
entry:
