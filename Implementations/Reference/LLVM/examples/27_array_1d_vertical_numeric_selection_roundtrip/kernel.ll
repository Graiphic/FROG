; Example 27 FROG native kernel artifact: 1D vertical Array selected-element roundtrip.
...
source_filename = "Examples/27_array_1d_vertical_numeric_selection_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogRunResult = type { i8, i16, i16 }

define void @frog_example27_run(i16 %element_value, ptr %out_result) {
entry:
