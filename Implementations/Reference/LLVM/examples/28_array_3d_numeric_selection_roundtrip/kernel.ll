; Example 28 FROG native kernel artifact: 3D Array selected-element roundtrip.
...
source_filename = "Examples/28_array_3d_numeric_selection_roundtrip/main.lowering.json"
target triple = "x86_64-pc-windows-msvc"

%FrogRunResult = type { i8, i16, i16 }

define void @frog_example28_run(i16 %element_value, ptr %out_result) {
entry:
