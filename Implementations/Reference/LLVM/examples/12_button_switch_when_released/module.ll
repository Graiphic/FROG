; FROG example 12 - LLVM Button switch_when_released Boolean proof
...
@fmt_output = private unnamed_addr constant [20 x i8] c"public_switched=%s\0A\00"
...
run:
  ...
  %fmt_output_ptr = getelementptr inbounds [20 x i8], ptr @fmt_output, i64 0, i64 0
