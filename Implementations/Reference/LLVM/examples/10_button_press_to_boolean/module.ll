; FROG example 10 - LLVM Button press to Boolean proof
...
@fmt_input = private unnamed_addr constant [20 x i8] c"trigger_pressed=%s\0A\00"
@fmt_output = private unnamed_addr constant [19 x i8] c"public_pressed=%s\0A\00"
...
run:
  ...
  %fmt_input_ptr = getelementptr inbounds [20 x i8], ptr @fmt_input, i64 0, i64 0
