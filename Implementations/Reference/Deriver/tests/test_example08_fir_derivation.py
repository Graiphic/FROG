...
SOURCE = ROOT / "Examples" / "08_enum_value_roundtrip" / "main.frog"
EXPECTED = ROOT / "Examples" / "08_enum_value_roundtrip" / "main.fir.json"


def test_example08_deriver_check_passes() -> None:
...
def test_example08_deriver_writes_json(tmp_path: Path) -> None:
...
def test_example08_rule_module_derives_expected_fir() -> None:
    source = load_json(SOURCE)
    generated = derive_fir_from_source(source, "Examples/08_enum_value_roundtrip/main.frog")
