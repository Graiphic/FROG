...
<p>
Example <code>05</code> is now also checked through the generic contract executor for the bounded headless accumulator path and the published <code>.wfrog</code> snapshot.
The specialized Example 05 checker remains active in parallel because it preserves the richer runtime-family validation posture.
</p>
