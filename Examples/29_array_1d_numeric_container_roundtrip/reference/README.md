...
This directory records the accepted public reference snapshot for Example 29, `Array 1D Numeric Container Roundtrip`.
...
<p align="center">
  <img src="./screenshot.png" alt="Accepted Example 29 Array 1D Numeric Container Roundtrip snapshot" width="760" />
</p>
