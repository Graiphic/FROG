# Example 29 Reference Snapshot

This directory records the accepted public reference snapshot for Example 29,
`Array 1D Numeric Container Roundtrip`.

1D Array container control-to-indicator roundtrip using Default Array cells that instantiate Default Numeric element widgets.
...
<p align="center">
  <img src="./screenshot.svg" alt="Accepted Example 29 Array 1D Numeric Container Roundtrip snapshot" width="400" />
</p>
