...
the default `state_face` at 64 x 64 source units. The visible 4 source-unit
band between them matches the Default Numeric aura standard. IDE selection displays
...
lowering, host contract, and Default Boolean realization assets.
