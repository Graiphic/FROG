...
The C++ reference browser host must render the grid, the `placement_bounds` aura, the `state_face` surface, and optional `state_text` in a real browser before the example is considered reviewed.
