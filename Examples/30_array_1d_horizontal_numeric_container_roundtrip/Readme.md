# Example 30 - Array 1D Horizontal Numeric Container Roundtrip
...
Example 30 is a post-public-boundary widget progression example. It is intentionally C++-first until the visual and behavioral contract is accepted. Graiphic private runtimes validate this behavior unless the example is explicitly promoted later as public reference runtime material.
