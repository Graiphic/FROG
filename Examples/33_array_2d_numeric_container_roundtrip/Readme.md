...
- Control and indicator cells both use `element.layout.fit_part = placement_bounds`; the Array cell is the contained Numeric aura (`96x32`). Controls keep increment/decrement controls visible; indicators are read-only and use source-owned grey style values.
