...
retained for traceability because it validated 2D Array rank, shape, index,
materialization, selection posture, and native value flow before the
widget-composed Array container surface was introduced.
