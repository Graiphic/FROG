...
<p>
The Button is a command/value widget: the press edge latches TRUE, the running
program reads one TRUE value, and that read resets the stored Button value back
to FALSE. The Boolean indicator shows the consumed program pulse, not a
