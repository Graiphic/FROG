...
retained for traceability because it validated 3D Array rank, layer/row/column
indexing, regular materialization, selection posture, and native value flow
before the widget-composed Array container surface was introduced.
