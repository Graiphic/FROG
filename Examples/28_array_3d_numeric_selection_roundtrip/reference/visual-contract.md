# Example 28 Visual Contract

Example 28 records the accepted browser-host reference surface for
`Array 3D Numeric Selection Roundtrip`.

This is an intermediate non-widget-composed Array development snapshot. It is
preserved for traceability and regression context, but it is not the final
runtime rendering target for Array. The final rendering direction is the
widget-composed Array container posture introduced by Examples 29-30.
