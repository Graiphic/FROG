# Example 38 Reference Snapshot

This directory records the accepted public reference snapshot for Example 38, `Boolean Array Container Dimension Count Roundtrip`.
...
<p align="center">
  <img src="./screenshot.png" alt="Accepted Example 38 Boolean Array Container Dimension Count Roundtrip snapshot" width="760" />
</p>
