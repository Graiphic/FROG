...
<h1 align="center">Array Reference Snapshots</h1>

<p align="center">
  <strong>Accepted public visual dossiers for the current Array widget progression</strong><br/>
...
<p>
This page collects the public Array reference snapshots that were added after the
initial Example 05-30 reference batch. Each linked page embeds its accepted
snapshot directly and links the accepted state JSON, visual contract,
machine-readable contract, and artifact index.
</p>

<p>
These records are public evidence only. They do not publish Graiphic private
runtime source and they do not redefine the FROG language specification.
</p>
...
<section>
  ...
  <p align="center">
    <a href="../32_array_1d_horizontal_visible_count_property_roundtrip/reference/README.md"><img src="../32_array_1d_horizontal_visible_count_property_roundtrip/reference/screenshot.svg" alt="Accepted Example 32 Array 1D horizontal visible-count property snapshot" width="700" /></a>
  </p>
  <ul>
...
<section>
  ...
  <p align="center">
    <a href="../33_array_2d_numeric_container_roundtrip/reference/README.md"><img src="../33_array_2d_numeric_container_roundtrip/reference/screenshot.svg" alt="Accepted Example 33 Array 2D Numeric container snapshot" width="700" /></a>
  </p>
  <ul>
...
<section>
  <h3>Example 34: Array 2D visible row/column property write</h3>
  <p><a href="../34_array_2d_visible_counts_property_roundtrip/reference/README.md">Reference snapshot README</a></p>
  <p align="center">
    <a href="../34_array_2d_visible_counts_property_roundtrip/reference/README.md"><img src="../34_array_2d_visible_counts_property_roundtrip/reference/screenshot.svg" alt="Accepted Example 34 Array 2D visible-count property snapshot" width="700" /></a>
  </p>
  <ul>
